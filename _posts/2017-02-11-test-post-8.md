...
<table>
  <tr>
    <td>![Mathilda](https://github.com/coianac/coianac.github.io/blob/master/img/MathildaYellow.jpeg){:height="300px"}!</td>
    <td>![Mathilda](https://github.com/coianac/coianac.github.io/blob/master/img/MathildaYellow.jpeg){:height="300px"}</td>
    <td>![Mathilda](img/MathildaYellow.jpeg){:height="300px"}!</td>
    <td>![Mathilda](img/MathildaYellow.jpeg){:height="300px"}</td>
    <td> </td>
  </tr>
</table>
